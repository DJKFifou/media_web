...
import {User, Article_Frequency} from ".prisma/client";
...
export default function User(){
	...
	const title = (article_frequency: string) => {
		...
		switch (article_frequency){
			case 'DAY': return `Selection du ${dayString}`
			case 'WEEK': return 'Selection de la semaine'
			case 'MONTH': return `Selection du ${monthString}`
		}
	}
